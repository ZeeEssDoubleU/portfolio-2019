...
const onWindowResize = (dispatch, themeContext) => {
  if (typeof window !== "undefined") {
    ...
    window.innerWidth < themeContext.tablet ? dispatch({
      type: IS_MOBILE,
      payload: true
    }) : dispatch({
      type: IS_MOBILE,
    ...
    window.innerWidth >= themeContext.desktop ? dispatch({
      type: IS_DESKTOP,
      payload: true
    }) : dispatch({
      type: IS_DESKTOP,
...
const initState = typeof window !== "undefined" ? {
  ...
  isMobile: window.innerWidth < _styles_styled_components__WEBPACK_IMPORTED_MODULE_1__.theme.tablet,
  isDesktop: window.innerWidth >= _styles_styled_components__WEBPACK_IMPORTED_MODULE_1__.theme.desktop,
  pathname: null,
  prevPathname: null
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (styled_components__WEBPACK_IMPORTED_MODULE_0__.createGlobalStyle`
      html, body {
         ...
         overflow-x: hidden;
         overflow-y: ${props => props.menuExpanded || props.modal ? "hidden" : "auto"};
         &.using-mouse :focus {
